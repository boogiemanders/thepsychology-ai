---
topic_name: Socioemotional Development – Moral Development
domain: 4: Growth & Lifespan Development
slug: socioemotional-development-moral-development
generated_at: 2025-11-16T15:47:08.697Z
version: 3
---
...
1. **He underestimated young children.** More recent research shows that even preschoolers can understand intentions under the right circumstances. They're more morally sophisticated than Piaget gave them credit for.

2. **He thought moral development stopped too early.** By suggesting the final stage begins around age 10-11, Piaget missed all the complex moral reasoning that develops during adolescence and adulthood.
...
- **Pre**moral = **Pre**schoolers (0-5): Don't really get it yet
- **Hetero**nomous = **Hero** worship (5-10): Rules from authorities, consequences matter
- **Auto**nomous = **Auto**pilot off (10+): Make own judgments, intentions matter

**For Kohlberg's Stages:**

Use this organization:

**PRE**conventional (before social conventions)
- Stage 1: **P**unishment focus
- Stage 2: **R**ewards/personal benefit focus

**Conventional** (social conventions matter)
- Stage 3: **C**aring what others think
- Stage 4: **C**ommitment to laws and order

**POST**conventional (beyond social conventions)
- Stage 5: Democratic **D**ecisions can change laws
- Stage 6: Universal **U**nchanging principles
