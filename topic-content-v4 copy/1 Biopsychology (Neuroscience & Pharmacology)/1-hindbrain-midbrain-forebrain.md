---
topic_name: Brain Regions/Functions – Hindbrain, Midbrain, and Subcortical Forebrain…
domain: 1: Biological Bases
slug: brain-regions-functions-hindbrain-midbrain-and-subcortical-forebrain
generated_at: 2025-11-16T14:56:36.355Z
version: 3
---
...
| Function Category | Specific Roles |
|------------------|----------------|
| Physical survival | Body temperature, blood pressure, heart rate, respiration |
| Drives | Thirst, hunger, sexual activity, reproduction |
...
**1. "The cerebellum only does balance and coordination."**
Wrong. It's also crucial for procedural memory, implicit memory, attention, language processing, and understanding where things are in space (visuospatial abilities). Don't miss questions that link cerebellar damage to memory problems.
...
**5. "Parkinson's disease is a basal ganglia problem."**
...
- **T**halamus damage
- **A**nterograde + retrograde amnesia  
