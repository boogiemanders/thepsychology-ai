...
export const siteConfig = {
  ...
  companyShowcase: {
    ...
    companyLogos: [
      { id: 1, name: "UCLA-David Geffen School of Medicine", src: "/dgsom.png", member: "anders" },
      { id: 2, name: "NYU Langone Health", src: "/nyu.png", member: "anders" },
      { id: 3, name: "Montefiore Einstein", src: "/monte.png", member: "anders" },
      { id: 4, name: "LIU Post", src: "/liu.png", member: "anders" },
      { id: 5, name: "Pratt Institute", src: "/pratt.png", member: "anders" },
      { id: 6, name: "Northwestern University", src: null, member: "yael" },
      { id: 7, name: "The Chicago School", src: null, member: "yael" },
      { id: 8, name: "Advocate IL Masonic", src: null, member: "yael" },
    ],
  },
  bentoSection: {
    title: "Examples",
    ...
    pricingItems: [
      {
        ...
        period: "month",
        yearlyPrice: "n/a",
        features: ["Know where you stand in 15 min", "Focus on what moves your score", "All 8 EPPP domains covered", "Built-in burnout prevention"],
        featuresLabel: "Everything includes:",
        description: "No card. Free until Feb. Lock in $20/mo before March ($30).",
      ...
      },
      {
        ...
        period: "month",
        yearlyPrice: "$10000",
        features: ["Everything in Pro", "2× 45-min calls/month", "Personal study plan built for you", "Priority support", "Others spend $900 over 12 months. Pass in 1."],
