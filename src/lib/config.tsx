...
export const siteConfig = {
  ...
  keywords: [
    ...
    "free EPPP practice test",
    "psychology licensure exam prep",
    "EPPP exam format",
    "EPPP domain weights",
    "AATBS review",
    "AATBS vs",
    "PsychPrep review",
    "EPPP prep programs compared",
  ],
  links: {
  ...
  companyShowcase: {
    ...
    companyLogos: [
      ...
      { id: 6, name: "Northwestern University", src: "/northwestern.png", member: "yael", invertLight: true },
      { id: 7, name: "The Chicago School", src: "/chicago-school.png", member: "yael", invertLight: true },
  ...
  pricing: {
    ...
    description: "Start here for free. See if it works before spending a dollar. $40/mo if you join in July (locked in), then $50/mo from August 1.",
    pricingItems: [
      {
        name: "Pro",
        href: "/#get-started",
  ...
  faqSection: {
    ...
    faQitems: [
      ...
      },
      {
        ...
        answer:
          "That's why we offer 7 days free with no credit card required. The full cost after the trial is $40/month if you join in July (locked in), then $50/month from August 1, still a fraction of AATBS. You should be able to try a prep program and see real results before spending money, especially when early-career psychologists are already financially stretched.",
      },
      {
        id: 21,
      ...
      },
      {
        ...
        answer:
          "After 7 days, Pro is $40/month if you join in July (locked in), then $50/month from August 1. Cancel anytime. No contracts, no cancellation fees. You keep access to everything as long as you’re subscribed.",
      },
      {
        id: 16,
      ...
      },
      {
        ...
        answer:
          "No physical materials, no large staff, no corporate overhead. The founder built this as a solo psychologist using AI tools. AATBS charges $849-$1,799. We charge $40/month if you join in July (locked in), then $50/month from August 1, because passing the EPPP shouldn't require going into more debt.",
      },
    ],
  },
  ctaSection: {
