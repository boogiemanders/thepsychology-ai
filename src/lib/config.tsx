    ...
    pricingItems: [
      {
        ...
        period: "month",
        yearlyPrice: "n/a",
        features: ["Learn: 70+ audio lessons", "Practice: 10-min targeted quizzes", "Simulate: Real exam tools (highlight, flag, timer)", "Personalize: Custom metaphors + focus areas", "Recover: 5-min mental resets"],
        featuresLabel: "Everything includes:",
        description: "$0 now (no card) → Lock in $20/mo Feb → $30 after",
