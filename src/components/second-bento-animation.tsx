...
export function ReasoningBasic() {
  const reasoningText = `Standard 5 is Integrity. Think of it like holding the Reality Stone — it controls how your professional image shapes the world around you. Use it wrong, and reality bends in harmful ways.
