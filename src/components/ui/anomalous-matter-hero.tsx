  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color('#a1a1aa') },
      },
      vertexShader: `
        uniform float time;
...
export function AnomalousMatterHero({
  eyebrow = 'thePsychology.ai',
  title = 'Lab',
  description = 'Tools that save you time. From licensure to session notes to side projects.',
}: AnomalousMatterHeroProps) {
  return (
    <section
      role="banner"
      className="relative w-full h-[70vh] min-h-[480px] overflow-hidden"
    >
      <GenerativeArtScene />
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4 pointer-events-none">
        <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-zinc-400 dark:text-zinc-500 mb-3">
          {eyebrow}
        </p>
