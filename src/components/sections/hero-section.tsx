      ...
      <div className="relative flex flex-col items-center w-full px-6">
        <div className="relative z-10 pt-32 pb-20 max-w-3xl mx-auto h-full w-full flex flex-col gap-10 items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-5">
            {hero.title ? (
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium tracking-tighter text-balance text-center text-white relative -translate-y-[20px] md:translate-y-0">
                {hero.title}
              </h1>
            ) : null}
            {hero.description ? (
