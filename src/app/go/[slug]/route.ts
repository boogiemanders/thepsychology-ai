...
// Branded short link for social posts: thepsychology.ai/go/<topic> 307-redirects to the
// homepage with UTM params for Google Analytics. The visible link stays clean and on-brand;
// the campaign is the <topic> slug. Defaults: utm_source=linkedin, utm_medium=social. Override
// the source with ?s= (e.g. /go/eppp-cost?s=tiktok) when a post runs on another platform.
