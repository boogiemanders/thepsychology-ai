...
// (e.g. /go/eppp-cost?s=tiktok) when a post runs on another platform. Unmapped slugs land on the
// homepage; slugs listed in DESTINATIONS land on that specific page (same UTM tracking).
