...
const projects = [
  {
    ...
    description: 'Free. We check NYSED daily. The second your license posts, you get an email. No more refreshing.',
  ...
  },
  {
    ...
    description: 'Free. ZocDoc referral comes in. SimplePractice intake fills itself. Your front desk stops typing things twice.',
    category: 'clinical-practice',
    categoryLabel: '02 Psychologist Tools',
    status: 'dev' as const,
    tags: ['Chrome Extension', 'Automation', 'Free'],
  },
  {
    id: 4,
    title: 'SENSE',
    description: 'Free. A mind-body assessment tool developed by Dr. Neha Menon.',
    category: 'clinical-practice',
    categoryLabel: '02 Psychologist Tools',
    href: '/lab/sense',
    status: 'dev' as const,
    tags: ['Next.js App', 'Prisma', 'Clinical', 'Free'],
  },
  {
    id: 5,
