...
export const SUBTESTS: Subtest[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { k: '5',  blocks: 4, t: '45"',  trials: false, scoreMax: 4, validScores: [0, 4] },
      { k: '6',  blocks: 4, t: '60"',  trials: false, scoreMax: 4, validScores: [0, 4] },
      { k: '7',  blocks: 4, t: '60"',  trials: false, scoreMax: 4, validScores: [0, 4] },
      { k: '8',  blocks: 4, t: '60"',  trials: false, scoreMax: 4, validScores: [0, 4] },
