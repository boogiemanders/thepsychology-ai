...
export const metadata: Metadata = {
  title: 'Tower (EF Battery) | thePsychology.ai',
  description:
    'Web-based Tower of Hanoi with drag-level kinematic capture. Research prototype for an executive-functioning assessment battery.',
}
    ...
    <main className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <header className="mb-16">
        ...
        <p className="max-w-xl text-[15px] leading-relaxed text-zinc-500 dark:text-zinc-400">
          A digital Tower of Hanoi prototype. Five puzzles of increasing size measure planning, working
          memory, and inhibition. Pointer movement is sampled during each drag alongside first-move
          latency, excess moves past the shortest path, and rule violations.
        </p>
      </header>
      ...
      <footer className="mt-24 border-t border-zinc-100 pt-8 dark:border-zinc-800/50">
        <p className="text-[11px] leading-relaxed text-zinc-400 dark:text-zinc-500">
          ...
          copyrighted test. Participant kinematics are stored only in browser memory and included in
          the downloadable JSON for offline analysis; no data leaves this device unless you export
          it.
        </p>
      </footer>
    </main>
