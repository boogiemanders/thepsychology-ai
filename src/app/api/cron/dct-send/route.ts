...
const PARAS = [
  ...
  "Two reasons it might help your students. It's affordable ($40/month now, $50 from August 1, vs. the usual $849 to $1,799), and the questions are written the way the EPPP actually words them, so practice scores mean something. And the exam itself costs about $692 every attempt, so every retake a student avoids is real money saved.",
