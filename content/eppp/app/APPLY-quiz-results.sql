-- =============================================================================
-- Quiz Results — Paste-in bundle for Supabase Studio SQL Editor
-- Source: supabase/migrations/20260415_create_quiz_results.sql
-- Safe to re-run: all CREATEs use IF NOT EXISTS and DROP POLICY IF EXISTS.
-- =============================================================================
