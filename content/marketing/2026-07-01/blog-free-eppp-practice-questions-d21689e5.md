...
status: pending
tags: [mktg]
created: 2026-07-01T14:23:46.871789+00:00
---

#mktg

# Free EPPP Practice Questions (2026): 50 Application-Based Questions With Rationales, By Domain
...
These 50 questions are written to match the style and difficulty of the actual EPPP. They're organized by domain, and every question includes a detailed explanation of why the correct answer is correct and why the other options fall short. I'm Dr. Anders Chan. I scored 588 on the EPPP and built thePsychology.ai, so I've read a lot of bad practice questions and written a lot of good ones.

Want thousands more like these that adapt to your weak spots? [Try thePsychology.ai free for 7 days](https://thepsychology.ai?utm_source=blog&utm_medium=cta&utm_campaign=free-eppp-practice-questions), no credit card required (a .edu email gets a full month). Study less, score higher.
...
If you want a structured version of this, see the [free EPPP study plan](/blog/free-eppp-study-plan) and the [EPPP exam format](/blog/eppp-exam-format) breakdown.

## EPPP Practice Questions by Domain

The fastest way to raise your score is to stop studying what you already know. Drill your weakest domain instead. The eight domains are not equal weight, so a domain you're bad at that's also worth 16% of the exam should get far more of your time than a 7% domain you already have down.

We keep a full set broken out one domain at a time, with more questions per area, on the [EPPP practice questions by domain](/blog/eppp-practice-questions-by-domain) hub. Start there, find the one that scares you, and grind it first.

---

## Biological Bases of Behavior (10% of the EPPP)
...
A) Weight gain from increased appetite
...
A) Inability to form new declarative memories
B) Poor decision-making in situations involving risk and reward despite intact intellectual functioning
C) Difficulty recognizing familiar faces
D) Loss of the ability to plan and execute sequential motor tasks
...
## Cognitive-Affective Bases of Behavior (13% of the EPPP)
...
A) Operant conditioning through positive reinforcement
B) Stimulus generalization following classical conditioning
C) Observational learning
D) Cognitive restructuring failure
...
A) The beginning of the list (primacy effect)
B) The middle of the list
C) The end of the list (recency effect)
D) All portions equally
...
## Social and Cultural Bases of Behavior (11% of the EPPP)
...
A) The client likely has social anxiety disorder
B) Indirect communication and averted gaze may reflect cultural values of respect and collectivism
C) The client is demonstrating an insecure attachment style
D) The therapist should directly confront the avoidance to build a stronger alliance
...
A) Conformity rates increase due to information overload
B) Conformity rates decrease significantly
C) Conformity rates remain unchanged
D) Conformity rates increase due to reactance
...
B) Social inhibition
C) Social loafing
D) Diffusion of responsibility in emergencies
...
## Growth and Lifespan Development (12% of the EPPP)
...
## Assessment and Diagnosis (16% of the EPPP)
...
A) Conclude the client has severe psychopathology
B) Consider whether the profile may be invalid due to overreporting or random responding
C) Ignore the F scale and interpret the clinical scales as usual
D) Diagnose the client with a factitious disorder
...
A) Test B, because higher specificity reduces false positives
B) Test A, because higher sensitivity reduces false negatives
C) Either test, as sensitivity and specificity are equally important in screening
D) Neither test without knowing the base rate
...
A) The client's true IQ is exactly 100
B) There is a 95% probability that the client's true IQ falls between 95 and 105
C) If tested repeatedly, 95% of the obtained scores would fall between 95 and 105
D) The client is of exactly average intelligence
...
A) Verify that the discrepancy is at least two standard deviations
B) Rule out that the difficulties are better explained by intellectual disability, sensory deficits, inadequate instruction, or other factors
C) Confirm that the child fails to respond to evidence-based intervention (RTI)
D) Both B and C are appropriate considerations depending on the diagnostic framework used
...
## Treatment, Intervention, Prevention, and Supervision (15% of the EPPP)
...
A) Systematic desensitization with relaxation training
B) Exposure and response prevention (ERP)
C) Cognitive therapy focusing on challenging irrational beliefs about contamination
D) EMDR
...
D) Psychodynamic therapy informed by object relations theory
...
A) Teach the client to avoid panic-inducing situations
B) Reduce the client's catastrophic interpretation of physical sensations
C) Condition a relaxation response to physical arousal
D) Determine the medical cause of the panic symptoms
...
A) Gottman method couples therapy
...
A) Passive ideation, depressed mood, female sex, history of one prior attempt
B) Active ideation with a specific plan and access to means, recent loss, male sex, history of multiple prior attempts
C) Passive ideation, substance use history, family history of depression, unemployment
D) Active ideation without a plan, chronic pain, social isolation, age 25
...
A) Switch entirely to psychodynamic therapy
B) Add acceptance-based strategies (worry exposure, mindfulness, values clarification)
C) Increase session frequency to three times per week
D) Discontinue therapy and recommend medication only
...
## Research Methods and Statistics (7% of the EPPP)
...
B) Independent samples t-test on post-test scores
C) Mixed-design ANOVA (group x time)
D) Chi-square test
...
A) Exercise has a meaningful causal effect on academic performance
B) The relationship is statistically significant but practically small, explaining about 2% of the variance
C) The large sample size means the finding is both statistically and practically significant
D) The correlation is too small to be real and is likely a Type I error
...
A) Insufficient power due to small sample sizes
B) Inflated Type I error rate due to multiple comparisons
C) Violation of the homogeneity of variance assumption
D) Inability to detect interaction effects
...
B) Partial correlation or multiple regression
C) One-way ANOVA
D) Factor analysis
...
B) Medium
C) Large
D) Cannot be interpreted without knowing the sample size
...
## Ethical, Legal, and Professional Issues (16% of the EPPP)
...
A) Comply immediately with the subpoena, as it is a legal order
B) Refuse the subpoena entirely, citing client privilege
C) Contact the client to discuss the subpoena and consult with an attorney about the legal obligations
D) Release only the diagnosis and treatment dates
...
A) Provide the custody recommendation based on observations from therapy
B) Decline to offer a custody opinion and explain the role conflict between therapist and evaluator
C) Provide the recommendation but note it is based on limited information
D) Refer the attorney to the child's other parent's therapist for a second opinion
...
A) Continue treatment since objectivity is not affected
B) Terminate the therapeutic relationship immediately
C) Consider whether the relationship could reasonably be expected to impair objectivity, and if so, take appropriate steps including referral
D) Disclose the relationship to the client and continue if the client consents
...
A) Schedule the appointment and begin treatment immediately
B) Refuse to see the individual and tell them to contact their current psychologist
C) Schedule the appointment but first attempt to contact the current psychologist with the client's permission to coordinate care
D) See the individual only for crisis intervention and refuse ongoing treatment
...
A) Must report suspected abuse regardless of the client's wishes, as mandatory reporting overrides confidentiality
B) Is not required to report because mandatory reporting laws typically apply only to child abuse, elder abuse, and abuse of dependent adults
C) Should follow the client's wishes, as client autonomy overrides reporting obligations
...
A) Release the complete report including test data, as the attorney has a right to it
B) Withhold the entire report to protect test security
C) Release the report but consider releasing test data only to a qualified professional to protect test security
D) Release only the summary and conclusions, permanently withholding all test data
...
A) Avoid giving any critical feedback to prevent triggering anxiety
B) Interpret the transference directly and explore the supervisee's childhood experiences
C) Provide feedback in a clear, specific, and supportive manner while acknowledging the dynamic and normalizing the supervisee's response
D) Refer the supervisee to personal therapy and postpone all feedback until treatment is complete
...
## Are These Like the Real EPPP?

Yes, and that's the whole point. The real EPPP Knowledge exam is built almost entirely from application-based vignettes, not recall flashcards. It rarely asks "What is the definition of X?" It asks "A psychologist is working with a client who presents with X. What is the most appropriate next step?" You have to know the concept and then apply it under a little pressure.

Most free question sets you'll find online are recall: match the term to the definition. Those are fine for a first pass, but they don't build the skill the exam actually tests. When you practice with recall items and then sit for an application exam, your practice score and your real score come apart. That's the 90%-on-practice, fail-the-real-thing gap people complain about.

The 50 questions above are written in the exam's own format on purpose. Each one puts you in a room with a client, a dataset, or an ethical bind and asks for the best move. If you can reason through these, your practice scores will translate to test day, because you're rehearsing the same cognitive move the exam demands.

That's also why our whole [question bank](https://thepsychology.ai?utm_source=blog&utm_medium=cta&utm_campaign=free-eppp-practice-questions) is application-based, with an adaptive engine that finds your weakest domains and drills them. For the full picture of what the test looks like, read [the EPPP exam format](/blog/eppp-exam-format) and [how the EPPP is scored](/blog/how-is-the-eppp-scored).
...
|--------|-----------|------------|
| Biological Bases | 1-6 | /6 |
| Cognitive-Affective | 7-12 | /6 |
| Social/Cultural | 13-18 | /6 |
| Growth/Lifespan | 19-24 | /6 |
| Assessment/Diagnosis | 25-30 | /6 |
| Treatment/Intervention | 31-36 | /6 |
| Research Methods | 37-42 | /6 |
| Ethics/Legal | 43-48 | /6 |
| Mixed | 49-50 | /2 |
...
These 50 questions are a snapshot. If you want adaptive practice that continuously identifies your weak areas and adjusts to close those gaps, [try thePsychology.ai free for 7 days](https://thepsychology.ai?utm_source=blog&utm_medium=cta&utm_campaign=free-eppp-practice-questions). Our question bank mirrors the application-based style of the real EPPP, and the adaptive engine does the opportunity score math for you after every session.

## Frequently Asked Questions

### Are these free EPPP practice questions with answers?

Yes. All 50 come with the correct answer plus a full rationale that explains why the right answer is right and why each wrong option falls short. Reading the rationale is where the real learning happens, so don't skip it.

### Do I need to sign up to use them?

No. Every question, answer, and rationale is on this page for free, no account and no email required. You only sign up if you want the adaptive engine and the larger bank, and even then the [7-day trial](https://thepsychology.ai?utm_source=blog&utm_medium=cta&utm_campaign=free-eppp-practice-questions) needs no credit card (a .edu email gets a full month).

### Is there a PDF?

Not yet as a formal download, but this page prints cleanly, so you can save it as a PDF from your browser (Print, then "Save as PDF") and mark up the questions offline. The live version stays more current than any file, since we update it as ASPPB changes the exam.

### Are 50 questions enough to pass the EPPP?

No, and no free set is. Fifty questions are a diagnostic, not a study plan. They tell you which domains are weak so you know where to spend your hours. To actually pass, most people need to work through a few thousand application-based questions and full-length practice exams that match the real format. Our bank has 2,200+ questions plus an adaptive engine that generates unlimited fresh ones, and 16 full-length practice exams.

### How current are these for the 2026 exam?

They match the current EPPP Knowledge exam: 225 items (175 scored, 50 unscored pretest), 8 content domains, a scaled score of 200 to 800, and an ASPPB-recommended passing score of 500 for independent practice (450 for supervised). The domain headers above use the current ASPPB Candidate Handbook weights. We update this page when the weights or format change.

### Is the EPPP changing? Should I wait?

No, don't wait. Today you take the EPPP Part 1 (the Knowledge exam), plus EPPP Part 2 (Skills) only if your state or provincial board requires it. What ASPPB paused in October 2024 was the mandate that every board adopt both parts, not the exam itself. Separately, a single integrated EPPP (six competency domains, mixing multiple-choice, scenario clusters, audio and video stimuli, and situational judgment, scored pass/fail) begins beta in 2027, goes live in Q4 2027, and becomes the only exam on April 1, 2028. If you're testing now, prepare for the current Knowledge exam. See [EPPP vs EPPP-2](/blog/eppp-vs-eppp-2) for the full timeline.

### What does the EPPP cost, and how many times can I retake it?

Part 1 runs about $692 per attempt ($600 to ASPPB plus $91.88 to Pearson VUE). You can take a part at most 4 times in any 12-month period, and ASPPB recommends waiting about 90 days between attempts, though boards set their own minimum. If a first attempt doesn't go your way, read [what to do after failing the EPPP](/blog/what-to-do-after-failing-the-eppp).

## Where thePsychology.ai Fits

I'll be straight with you. thePsychology.ai is $40 a month if you join in July 2026 (locked in for as long as you study), then $50 a month from August 1, still the lowest monthly price of any program on this list. Join in July to lock in $40/month before it rises to $50 on August 1. That gets you 80+ psychologist-written lessons, 2,200+ application-based questions plus an adaptive engine that generates unlimited fresh ones, 16 full-length practice exams, and built-in wellness tools for when the studying gets heavy. There's a Pro coaching tier if you want a human in the loop.

Where we fall short: we're newer, our community is smaller than the old-guard programs, and there's no native mobile app yet (the web app is mobile-responsive). If a pass guarantee is the thing that lets you sleep, some competitors sell one (with conditions), and we don't. For the honest full comparison, see [EPPP prep programs compared for 2026](/blog/eppp-prep-programs-compared-2026), plus head-to-heads with [AATBS](/blog/thepsychology-ai-vs-aatbs), [PsychPrep](/blog/thepsychology-ai-vs-psychprep), and [PrepJet](/blog/thepsychology-ai-vs-prepjet).

Want to see if the application-based style clicks for you? [Try thePsychology.ai free for 7 days](https://thepsychology.ai?utm_source=blog&utm_medium=cta&utm_campaign=free-eppp-practice-questions), no credit card required. Study less, score higher.

## Sources

- ASPPB EPPP Candidate Handbook (domain weights, passing score, fees, retake limits): https://asppb.net/wp-content/uploads/EPPP-Candidate-Handbook.pdf
...
- ASPPB EPPP eligibility and cost update (integrated exam timeline and fees): https://asppb.net/news/eppp-eligibility-updates-professional-practice-cost/

## Sources

- ASPPB. (2026). ASPPB EPPP Candidate Handbook (domain weights, passing score, fees, retake limits). <https://asppb.net/wp-content/uploads/EPPP-Candidate-Handbook.pdf>
