...
**For:** Dr. Inzinna + Tidal Health Group / web developer
**Last updated:** 2026-05-11

## TL;DR

To get Inzi on Dr. Inzinna's WordPress site, Tidal Health Group installs **one snippet** in the site's header/footer area. Same workflow as Google Analytics or Calendly.
...
If Tidal Health Group wants to limit it (e.g., hide on legal pages), most header/footer plugins support per-page rules. We can configure exclusions later.
