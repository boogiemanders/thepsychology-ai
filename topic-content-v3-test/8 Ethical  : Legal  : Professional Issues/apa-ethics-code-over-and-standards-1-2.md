---
topic_name: APA Ethics Code Over and Standards 1 & 2
domain: 8: Ethical, Legal & Professional Issues
slug: apa-ethics-code-over-and-standards-1-2
generated_at: 2025-11-16T16:42:34.255Z
...
2. **Identify relevant APA principles and standards** - What does the Ethics Code say?
3. **Identify relevant laws and regulations** - What does the law require?
4. **Consider stakeholder perspectives** - Who's affected and how?
5. **Develop and implement an action plan** - What will you actually do?
6. **Monitor and evaluate results** - Did it work? What happened?
...
1. **Clarify the nature of the conflict** - Make sure everyone understands there's an ethical issue
2. **Make your commitment to the Ethics Code known** - Don't just silently comply
3. **Take reasonable steps to resolve the conflict** - Try to find a solution that honors ethical responsibilities
...
1. **No problematic multiple relationship exists** - The person doesn't have a relationship with the service recipient that could impair objectivity
2. **The person has adequate competence** - Based on education, training, and experience
3. **You ensure competent service delivery** - You supervise and monitor the work
...
1. **Don't start new professional activities** when personal problems will likely impede effectiveness
2. **Take appropriate measures** when you become aware personal problems might negatively affect ongoing work
...
- **B**eneficence and Nonmaleficence (do good, avoid harm)
- **F**idelity and Responsibility (be trustworthy, give back)
- **I**ntegrity (be honest)
- **C**ulture and Justice (ensure fairness - okay, this is adapted, but it helps!)
- **E**veryone's Rights and Dignity (respect differences)

**For competence boundaries, use the "ETS" rule:**
- **E**ducation
- **T**raining
- **S**upervised experience
(Plus consultation, study, and professional experience)
...
- **S**ubstantial harm caused/likely
- **H**ard to resolve informally
- Try informal first (when appropriate), then go formal if needed

## Key Takeaways

- **Guidelines are suggestions; standards are mandatory rules** with enforcement mechanisms

- **The Ethics Code has four sections:** Introduction and Applicability, Preamble, General Principles (aspirational), and Ethical Standards (enforceable)

- **Personal actions can lead to APA sanctions** if they overlap with your professional role or involve felony convictions, even if they occur outside work

- **When ethics and law conflict:** Clarify, make your ethical commitment known, and take reasonable steps to resolve—but you can comply with law if reasonable efforts fail (except when it violates human rights)

- **Colleague violations:** Try informal resolution when appropriate; report formally when substantial harm occurred/likely, informal won't work, or informal failed

- **Competence is specific** to populations, techniques, and contexts—not just having a license

- **You can work outside current competence in limited situations:** emergencies, when no alternatives exist (with consultation/training), or when expanding your practice with proper preparation

- **Delegating work requires:** no problematic multiple relationships, adequate competence of the person you're delegating to, and your ongoing supervision

- **Personal problems affecting work require action:** don't start new activities when impaired, and take appropriate measures (consultation, limiting, suspending, or terminating activities) when problems arise

- **Evidence-based practice** integrates research, clinical expertise, and patient characteristics—it's not just following treatment manuals
