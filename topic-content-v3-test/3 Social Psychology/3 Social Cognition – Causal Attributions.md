---
topic_name: Social Cognition – Causal Attributions
domain: 3: Social Psychology
slug: social-cognition-causal-attributions
generated_at: 2025-11-16T15:23:20.860Z
...
**Internal vs. External**: Did the behavior come from something inside the person (their personality, abilities, character) or from outside circumstances (the situation, other people, luck)?

**Stable vs. Unstable**: Is the cause permanent and consistent, or is it temporary and changeable?
...
This is the big one, identified by Lee Ross in 1977. The fundamental attribution error is our tendency to overestimate personality factors and underestimate situational factors when explaining other people's behavior.
...
This bias, described by Jones and Nisbett in 1971, highlights a double standard we all use: We attribute our own behaviors to situations, but we attribute other people's behaviors to their personalities.

{{M}}When you're scrolling through your phone during a meeting, you know it's because the presenter is going over material you already covered, the room is stuffy, and you got an urgent text from a family member. But when you see someone else on their phone? They're clearly disrespectful and unprofessional{{/M}}.

Why does this happen? We have access to our own internal experiences, context, and history. We know all the situational pressures we face. But when observing others, we see their behavior without full access to their circumstances, so we fill in the gaps with assumptions about their character.

### The Self-Serving Bias

Ross and Sicoly described this in 1979, and you'll recognize it immediately. The self-serving bias means we take credit for our successes (internal attribution) but blame circumstances for our failures (external attribution).
...
This one comes in two flavors, both relevant for understanding group dynamics:

**Version 1** (Hamill, Wilson, & Nisbitt, 1980): We assume one group member's characteristics reflect the entire group. {{M}}You meet one therapist who uses a particular approach and seems defensive about research, and you conclude that everyone using that approach is anti-science{{/M}}. We generalize from the individual to the collective.

**Version 2** (Allison & Messick, 1985): We assume a group's decision reflects every individual member's opinion, even when we know the decision wasn't unanimous. {{M}}Your department votes 6-4 to implement a new policy, but people talk about it as if everyone agreed. Those four dissenters get erased from the narrative{{/M}}.

Both versions matter for understanding workplace dynamics, committee work, and how stereotypes about professional groups form and persist.
...
**Consensus**: Do other people do the same thing in this situation? High consensus means yes, most people would act this way. Low consensus means no, this person is unusual.

**Consistency**: Does this person usually act this way in similar situations? High consistency means yes, they always do this. Low consistency means no, this is unusual for them.

**Distinctiveness**: Does this person act differently in other situations? High distinctiveness means yes, they only do this in specific circumstances. Low distinctiveness means no, they act this way across many situations.

Let me show you how this works with a practical example:

{{M}}Imagine a colleague, Dr. Martinez, snaps at you during a case conference.{{/M}} Your brain processes:

- **Consensus**: Do other people snap during case conferences? (No, people are usually respectful = Low consensus)
...
{{M}}Dr. Chen consistently arrives late to supervision meetings.{{/M}}

- **Consensus**: Do other supervisees arrive late? (No = Low consensus)
- **Consistency**: Does Dr. Chen usually arrive late to supervision? (Yes, almost every week = High consistency)
- **Distinctiveness**: Does Dr. Chen arrive late to other meetings too? (You've heard yes = Low distinctiveness)

When consensus is LOW, consistency is HIGH, and distinctiveness is LOW, you make an internal (dispositional) attribution: {{M}}"Dr. Chen is disorganized" or "He doesn't prioritize supervision."{{/M}}

Here's a table to help you remember:

| Pattern | Consensus | Consistency | Distinctiveness | Attribution Type | Example |
|---------|-----------|-------------|-----------------|------------------|---------|
| Pattern 1 | Low | High | Low | Internal (Dispositional) | "That's just how they are" |
...
**Cultural Competence**: Remember Miller's research on cultural differences in attribution. Clients from collectivist cultures may make more situational attributions and consider relationship factors more heavily. Imposing an individualistic attribution style in therapy could constitute cultural mismatch.

## Common Misconceptions to Avoid

**Misconception 1**: "The fundamental attribution error means we always ignore situations."

Not quite. We do consider situations, but we don't weigh them heavily enough when explaining others' behavior. We acknowledge circumstances; we just don't give them enough credit.
...
These are normal cognitive processes that happen to everyone. They're features of human cognition, not bugs or moral failings. Understanding them helps us compensate for them, but we never fully eliminate them.
...
**For Kelley's Covariation Model**: Create a memory device using the first letters: CCD. {{M}}Think of it like a CD (remember those?) with tracks: Consensus, Consistency, Distinctiveness{{/M}}. When all three tracks play high (high, high, high), you get an external attribution. When the pattern is low, high, low, you get an internal attribution.

Here's a comparison table to study:

| Bias | What It Affects | Direction of Error | Key Feature |
|------|----------------|-------------------|-------------|
| Fundamental Attribution Error | Explaining others' behavior | Over-attribute to personality | Most common general bias |
| Actor-Observer Effect | Self vs. others | Self = situation; Others = personality | Dual perspective |
| Self-Serving Bias | Own successes vs. failures | Success = personality; Failure = situation | Ego protection |
| Ultimate Attribution Error | In-groups vs. out-groups | In-group gets benefit of doubt | Fuels prejudice |
| Group Attribution Error | Individual vs. group | Generalizes incorrectly | Two versions |

## Key Takeaways

- **Causal attributions** are explanations we generate for why behaviors occur, categorized along three dimensions: internal/external, stable/unstable, and specific/global

- **Explanatory style** (optimistic vs. pessimistic) affects mental health, with pessimistic styles attributing negative events to internal, stable, and global causes
...
- **Group attribution error**: Either generalizing from one member to whole group, or assuming group decisions reflect all individual members' views

- **Kelley's covariation model** provides a rational framework: We should consider consensus (what others do), consistency (what this person usually does), and distinctiveness (how specific the behavior is to this situation)
