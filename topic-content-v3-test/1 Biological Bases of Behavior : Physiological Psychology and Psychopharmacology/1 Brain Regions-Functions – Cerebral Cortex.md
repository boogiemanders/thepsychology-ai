---
topic_name: Brain Regions/Functions – Cerebral Cortex
domain: 1: Biological Bases
slug: brain-regions-functions-cerebral-cortex
generated_at: 2025-11-16T14:54:30.683Z
...
| Lobe | Primary Location | Main Functions |
|------|-----------------|----------------|
| Frontal | Front of brain | Movement, language production, executive functions, personality |
| Temporal | Sides (near temples) | Hearing, language comprehension |
| Parietal | Top-back area | Touch, body awareness, skilled movements |
| Occipital | Very back | Vision processing |

## The Frontal Lobe: Your Brain's Executive Suite

The frontal lobe houses three critical areas that will come up repeatedly on the EPPP and in your clinical work.
...
The temporal lobes sit on the sides of your brain, roughly near your temples. They handle auditory processing and language comprehension.
...
|------|-------------|---------|
| Limb-kinetic | Can't make precise, coordinated movements with fingers, hands, arms, or legs | Can't perform fine motor tasks like buttoning a shirt |
| Ideomotor | Can't imitate movements or perform them on command | Can't pretend to comb hair when asked, even though they can do it spontaneously |
| Ideational | Can't plan and execute sequential tasks | Can't complete the steps needed to make a sandwich in the right order |
...
|---------|----------------|-------------------|
| Speech production | Impaired (slow, effortful) | Fluent but meaningless |
| Comprehension | Relatively intact | Impaired |
| Repetition | Impaired | Impaired |
| Anomia | Present | Present |
| Location | Frontal lobe | Temporal lobe |

**For the PFC Regions:**
Use the acronym **DOLL VINE VOTE OUT** to remember the four areas and their general functions:
- **DO**rsolateral: **L**ogic, working memory
- **V**entrolateral: **I**nhibition, **N**egotiating emotions
- **V**entromedial: **O**thers' emotions (social cognition), **T**hinking morally, **E**motion
- **O**rbitofrontal: social filter, stop **UT**tering inappropriate things

**For Gerstmann's Syndrome:**
Remember the phrase "**RAFF**" (like a drawing raffle):
- **R**ight-left disorientation
- **A**graphia
- **F**inger agnosia
- **F**inger counting problems (acalculia)
