---
topic_name: Sensation and Perception
domain: 1: Biological Bases
slug: sensation-and-perception
generated_at: 2025-11-16T15:08:45.214Z
...
Let's break down these concepts in a way that sticks with you through exam day and beyond.
...
For the EPPP, you need to know that color vision involves two complementary theories that work at different stages of visual processing.

### Trichromatic Theory

This theory explains what happens at the retina level. You have three types of cones, each most sensitive to different wavelengths: red, green, or blue. All the colors you see result from different combinations of these three cone types being activated.

{{M}}It's similar to how your computer screen creates millions of colors using just red, green, and blue pixels.{{/M}} This theory works well for explaining the initial stage of color vision.

### Opponent-Process Theory

This theory explains what happens after the retina, in subsequent neural processing. It proposes that color information is processed through three opposing pairs: red versus green, blue versus yellow, and black versus white.

The opponent-process theory beautifully explains two phenomena:

1. **Certain types of colorblindness**: People with red-green colorblindness can't distinguish between these colors because that opponent channel isn't working properly.
...
This genetics pattern matters clinically: when you see sex-linked inheritance patterns in other conditions, the same logic applies.

## Depth Perception: How We Navigate 3D Space

Your retina is two-dimensional, yet you perceive a three-dimensional world. Your brain uses multiple cues to construct depth perception, divided into two categories:

### Binocular Cues (Two Eyes Required)

These cues work for objects relatively close to you:
...
These cues work at greater distances and explain why people with vision in only one eye can still judge depth:
...
## Pain: More Than Just a Physical Signal

Pain is fascinating because it's simultaneously a sensory and emotional experience. The International Association for the Study of Pain defines it as "an unpleasant sensory and emotional experience associated with, or resembling that associated with, actual or potential tissue damage."

Notice what this definition allows: pain can occur without tissue damage. This is crucial for understanding chronic pain conditions, phantom limb pain, and psychosomatic presentations.

### Gate Control Theory

Gate control theory revolutionized pain understanding by explaining why pain isn't simply a direct signal from injury to brain. The theory proposes a "gate" mechanism in your spinal cord that can increase or decrease pain signals reaching your brain.

Here's how it works: Your spinal cord contains two types of nerve fibers. Small unmyelinated fibers transmit pain signals (opening the gate). Large myelinated fibers transmit other sensory information like touch, pressure, or temperature (closing the gate).
...
|---------------------------|----------------------------|
| Injury or inflammation | Physical counterstimulation (rubbing, heat, cold) |
| Focusing on pain | Distraction |
| Anxiety or depression | Relaxation |
...
Why does this matter for the EPPP? It's a clear example of how individual differences in neural wiring create fundamentally different perceptual experiences. This concept extends to understanding how clients may genuinely experience the world differently than you do.

## Psychophysics: The Math of Perception

Psychophysics studies the relationship between physical stimuli and psychological experience. For the EPPP, you need to understand several laws and theories that describe this relationship.
...
{{M}}This is why you easily notice when someone removes a single grocery bag from your hand when you're carrying one bag, but you might not notice if they remove one bag when you're carrying ten.{{/M}}

Weber's law works for middle-intensity stimuli but breaks down at extremes.

### Fechner's Law

Also called the Fechner-Weber law, this proposes a logarithmic relationship between stimulus intensity and psychological sensation. As physical intensity increases linearly, psychological sensation increases logarithmically (slower and slower).

{{M}}It's like salary increases: the psychological happiness from going from $30,000 to $40,000 feels much larger than going from $130,000 to $140,000, even though both are $10,000 increases.{{/M}}

Fechner's law is more accurate than Weber's law for extreme intensities but still has limitations.

### Stevens's Power Law

Stevens's power law is the most accurate and flexible. It proposes an exponential (power function) relationship between physical stimuli and psychological sensation, with different exponents for different types of stimuli.

Stevens used magnitude estimation: he'd give participants a reference stimulus with an assigned number, then have them assign numbers to other stimuli based on how intense they seemed. If a second weight felt twice as heavy, participants would assign it double the number.

What Stevens discovered: different sensations scale differently. Electric shock sensation grows much faster than stimulus intensity (high exponent), while brightness grows slower than light intensity (low exponent).

| **Stimulus Type** | **Relationship Pattern** |
|------------------|------------------------|
| Electric shock | Small increases feel much more intense |
| Pain | Moderate exponential growth |
| Brightness | Grows slower than physical intensity |
| Loudness | Moderate exponential growth |
...
In a typical SDT experiment, you'd experience many trials with either a weak signal (like a faint tone) plus background noise, or just background noise alone. You respond "yes" (signal present) or "no" (signal absent). Four outcomes are possible:

| **Reality** | **Your Response: "Yes"** | **Your Response: "No"** |
|------------|------------------------|------------------------|
| **Signal Present** | Hit (correct) | Miss (error) |
| **Signal Absent** | False Alarm (error) | Correct Rejection (correct) |

Your pattern of hits, false alarms, misses, and correct rejections reveals both your sensitivity and your decision criterion.

**Clinical relevance**: SDT applies directly to diagnostic decision-making. When evaluating whether a client meets criteria for a disorder, you're detecting signals (symptoms) against noise (normal variation, comorbid conditions, reporting bias). Your sensitivity depends on your assessment skills and knowledge. Your decision criterion reflects how conservative or liberal you are in making diagnoses.

{{M}}A clinician who fears missing serious conditions might have a liberal criterion (more willing to say "yes" to diagnosis), leading to more hits but also more false alarms. Another clinician who worries about overdiagnosis might have a conservative criterion (less willing to say "yes"), leading to fewer false alarms but more misses.{{/M}}

Understanding SDT helps you recognize that perfect accuracy is impossible when dealing with uncertain information, and that clinical judgment involves managing the trade-off between different types of errors.
...
**For color vision theories**: Remember "TRI-retina, OPPONENT-after" (trichromatic at retina level, opponent-process after retina).

**For rods vs. cones**: "Rods are for roughing it" (they work in dim conditions but give rough, colorless images). "Cones need conditions to be right" (they need good light but provide color and detail).

**For binocular vs. monocular cues**: Binocular = both eyes = better for close objects (both start with 'b'). Monocular = many cues = work for distant objects (think of the many landscape features you use to judge distance).

**For psychophysics laws**: 
- Weber = Proportion stays constant
- Fechner = Logarithmic (slows down)
...
- **Sensation** receives environmental stimuli; **perception** interprets them. Bottom-up processing builds from sensory data; top-down uses existing knowledge.

- **Rods** handle peripheral vision and low light but no color; **cones** provide color vision and detail but need bright light.

- **Trichromatic theory** (three cone types) explains retinal processing; **opponent-process theory** (opposing color pairs) explains post-retinal processing. Both are correct.

- **Red-green colorblindness** is X-linked recessive (more common in males); **blue-yellow colorblindness** is autosomal dominant (equal sex distribution).

- **Depth perception** uses binocular cues (retinal disparity, convergence) for nearby objects and monocular cues (relative size, interposition, etc.) for distant objects.

- **Gate control theory** explains how pain signals can be reduced by competing sensory input or by descending brain signals, validating psychological pain interventions.

- **Synesthesia** involves automatic cross-activation between sensory areas, demonstrating how neural connectivity creates individual differences in perception.

- **Weber's law**: JND is a constant proportion. **Fechner's law**: logarithmic relationship. **Stevens's power law**: exponential relationship varies by stimulus type.
