---
topic_name: Family Therapies and Group Therapies
domain: 6: Treatment & Intervention
slug: family-therapies-and-group-therapies
generated_at: 2025-11-16T16:27:30.700Z
...
1. **Stable coalition**: One parent and child consistently team up against the other parent
2. **Unstable coalition (triangulation)**: Each parent demands the child side with them
3. **Detouring-attack coalition**: Parents blame the child to avoid their own conflicts
4. **Detouring-support coalition**: Parents overprotect the child to avoid their conflicts
...
1. **Social stage**: Brief welcome, observe interactions
2. **Problem stage**: Each member describes the problem
3. **Interactional stage**: Family discusses the problem while therapist observes
4. **Goal-setting stage**: Define the problem and set concrete goals

The therapist then uses **straightforward directives** (instructions to change behavior) and **paradoxical directives**:

- **Prescribing the symptom**: Instruct the family to do the problematic behavior, often exaggerated. {{M}}If someone says they can't stop checking their phone during conversations, you might tell them to check it every 30 seconds for an hour.{{/M}} This helps them realize they actually control the behavior.

- **Restraining**: Encourage the family not to change or warn against changing too quickly. This uses their resistance therapeutically.

- **Ordeals**: Assign an unpleasant task to perform whenever the problem behavior occurs.
...
1. **Meeting**: Get to know family members separate from their problems
2. **Listening**: Identify dominant stories and "unique outcomes" (sparkling moments that contradict problem-saturated stories)
3. **Separating**: Externalize problems through language
4. **Enacting**: Identify alternative stories leading to preferred identities
5. **Solidifying**: Strengthen new stories through letters, expanded social networks, etc.
...
2. Changing interactional positions and creating bonding events
...
1. **Group cohesiveness**: The analogue of therapeutic alliance in individual therapy. Most consistently predicts positive outcomes and is a precondition for other factors.

2. **Instillation of hope**: Seeing others improve creates optimism about one's own progress.

3. **Universality**: Discovering others have similar problems reduces isolation. {{M}}It's the relief of realizing you're not the only one who struggles with the issue you thought was uniquely shameful.{{/M}}

4. **Altruism**: Helping others boosts self-esteem and sense of purpose.

5. **Imparting information**: Direct advice and psychoeducation from therapist and members.

6. **Development of socializing techniques**: Learning and practicing interpersonal skills in real-time.

7. **Corrective recapitulation of the primary family group**: The group resembles a family, allowing members to work through early family issues.

8. **Interpersonal learning**: Receiving feedback about how one's behavior affects others.

9. **Imitative behavior**: Learning by observing how others cope and interact.

10. **Catharsis**: Expressing feelings that have been held back.

11. **Existential factors**: Accepting responsibility for one's life, confronting mortality, and recognizing life's fundamental unfairness.

## Common Misconceptions to Avoid

**Misconception 1**: "Family therapy always involves the whole family in every session."
Reality: Some approaches (like Bowenian therapy) often work with just one or two members, believing change in one person affects the whole system.

**Misconception 2**: "All family therapy focuses on insight and understanding."
...
**Misconception 5**: "Narrative therapy is just about positive thinking."
Reality: It's about recognizing that our stories are socially constructed and can be reconstructed, not about ignoring real problems.
...
- For Bowen's concepts, remember **"DEFM"**: Differentiation, Emotional triangles, Family projection, Multigenerational transmission

- For Satir's dysfunctional styles, remember **"PBCD"** (like a disc format): Placating, Blaming, Computing, Distracting

- For structural therapy boundaries: **"RED"** = Rigid (disengaged), clear (Effective), Diffuse (enmeshed)
...
- **Systems thinking** views families as interconnected units where change in one part affects the whole. Homeostasis keeps families stable, sometimes maintaining unhealthy patterns.

- **Communication patterns** (double-binds, symmetrical/complementary interactions) can create or maintain psychopathology.

- **Bowen's Extended Family Systems** emphasizes differentiation and multigenerational patterns. Uses genograms and works to prevent emotional fusion.

- **Structural therapy (Minuchin)** focuses on boundaries (rigid, clear, or diffuse) and subsystems. Uses enactment and other techniques to restructure families.

- **Strategic therapy (Haley)** addresses power hierarchies through active, directive interventions including paradoxical techniques.

- **Milan Systemic** uses a team approach with circular questioning and family rituals to disrupt problematic "family games."

- **Satir's Conjoint therapy** identifies five communication styles (four dysfunctional, one congruent) and uses family sculpting.

- **Narrative therapy** externalizes problems and helps families construct alternative, less oppressive stories about their lives.

- **EFT** integrates attachment theory with systems thinking, focusing on emotional experiences to create new interaction patterns. Most effective for couples wanting to stay together.

- **FFT and MST** are evidence-based approaches for at-risk adolescents. FFT replaces problem behaviors with healthier ones serving the same functions. MST addresses multiple systems where problems occur.

- **Group therapy stages** progress from orientation (dependency) through conflict to cohesiveness, which is when real therapeutic work begins.
