...
generated_at: 2025-11-16T16:39:26.367Z
...
**Main effect**: The effect of one independent variable by itself.
...
**Advantage**: Better internal validity (more control over variables)
**Disadvantage**: Worse external validity (findings may not generalize)
...
1. **"Quasi-experimental means low quality"**: Not true. Sometimes random assignment is impossible or unethical. Quasi-experimental designs can be rigorous and valuable.

2. **"Single-subject designs aren't real research"**: Wrong. They provide strong evidence of treatment effectiveness and are incredibly practical for clinical work.

3. **"You need huge samples for good research"**: Sample size depends on your design and goals. Single-subject designs work with one person. Small qualitative studies can provide deep insights.

4. **"Qualitative research is just opinions"**: No. Rigorous qualitative research follows systematic methods and uses strategies like triangulation to ensure credibility.

5. **"Correlational research is useless because it doesn't show causation"**: Correlational research is valuable for prediction, identifying relationships worth studying experimentally, and studying variables you can't ethically manipulate.
