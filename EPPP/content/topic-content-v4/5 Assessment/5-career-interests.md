---
topic_name: Interest Inventories
domain: 5: Assessment
slug: interest-inventories
generated_at: 2025-11-16T15:52:18.640Z
...
- **G**eneral Occupational Themes
- **O**ccupational Scales
- **T**hen...
- **B**asic Interest Scales
- **O**ccupational Scales (wait, we said that)
- **P**ersonal Styles Scales
- **A**dministrative Indices
...
**For Holland's RIASEC themes**, here's a memory sentence:
"**R**eally **I**nteresting **A**rtists **S**ell **E**xcellent **C**eramics"

Or connect each to a stereotype:
- **R**ealistic: Ranch hand
- **I**nvestigative: Investigator (detective)
- **A**rtistic: Artist
- **S**ocial: Social worker
- **E**nterprising: Entrepreneur  
- **C**onventional: Controller (accountant)

**For the KOIS characteristics**: 
"**K**uder **C**reates **Forced** rankings, making **I**psative **P**rofiles **O**nly"
(Forced-choice format → Ipsative scores → Only intra-individual comparisons)

**For what interest inventories predict well**:
"**CSP** but not success" (Choice, Satisfaction, Persistence)
...
- **Predictive validity**: Good for job **choice, satisfaction, and persistence**; less accurate for **job success**
...
- **Empirical criterion keying**: Items selected based on their actual ability to distinguish between groups, not just theory

- **Modern Kuder**: Now available as Kuder Career Planning System with age-appropriate programs (Galaxy, Navigator, Journey)

- **Both tests use gender-specific comparisons** when matching to occupational groups
