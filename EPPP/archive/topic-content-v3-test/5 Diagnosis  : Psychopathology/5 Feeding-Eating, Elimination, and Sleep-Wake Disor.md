---
topic_name: Feeding/Eating, Elimination, and Sleep-Wake Disor
domain: 5: Diagnosis & Psychopathology
slug: feeding-eating-elimination-and-sleep-wake-disor
generated_at: 2025-11-16T16:05:53.208Z
...
| Compensatory behaviors | Inappropriate methods to prevent weight gain (self-induced vomiting, excessive exercise, laxatives, fasting) |
...
|--------------|---------------|
| Difficulty initiating sleep | Trouble falling asleep initially (sleep-onset/initial insomnia) |
| Difficulty maintaining sleep | Frequent or extended awakenings during the night (sleep maintenance/middle insomnia) |
| Early-morning awakening | Waking too early with inability to return to sleep (late insomnia) |
...
- **B**inge-eating disorder: Binges WITHOUT compensation
- **A**norexia nervosa: LOW weight, restriction
- **N**ervosa (bulimia): Normal weight, WITH compensation
...
- **C**ataplexy
- **H**ypocretin deficiency
- **I**rresistible sleep attacks
- **N**aps (at least 3x weekly for 3+ months)
