---
title: "Classical Conditioning - thePsychology.ai"
description: "Why Classical Conditioning Matters for Your EPPP (and Your Practice) You're at a coffee shop studying for the EPPP, and suddenly your phone buzzes with that specific text…"
url: "https://www.thepsychology.ai/resources/topics/2-cognitive-affective-bases/classical-conditioning"
canonical: "https://www.thepsychology.ai/resources/topics/2-cognitive-affective-bases/classical-conditioning"
...
| Term | Abbreviation | What It Means | Example (Pavlov's Dogs) | Modern Example |
| --- | --- | --- | --- | --- |
| Unconditioned Stimulus | US | Something that naturally triggers a response without any learning | Meat powder | Getting a performance review email from your boss |
| Unconditioned Response | UR | The natural, automatic response to the US | Salivation | Anxiety/nervousness |
| Conditioned Stimulus | CS | Something neutral that, after pairing with the US, triggers a learned response | Bell (after conditioning) | The notification sound on your work email |
| Conditioned Response | CR | The learned response to the CS (similar to UR but usually weaker) | Salivation to bell alone | Anxiety when hearing that notification sound |
...
**For the four key terms (US, UR, CS, CR):** "**U**n-" means natural/automatic, "**C**onditioned" means learned. The **S**timulus makes something happen; the **R**esponse is what happens. So US causes UR naturally; CS causes CR through learning.
