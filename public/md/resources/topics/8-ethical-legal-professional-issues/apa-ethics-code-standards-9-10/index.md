---
title: "APA Ethics Code Standards 9 & 10 - thePsychology.ai"
description: "Why Standards 9 and 10 Matter: Your Professional GPS Picture yourself on your first day as a licensed psychologist. A client sits across from you, and suddenly you're making…"
url: "https://www.thepsychology.ai/resources/topics/8-ethical-legal-professional-issues/apa-ethics-code-standards-9-10"
canonical: "https://www.thepsychology.ai/resources/topics/8-ethical-legal-professional-issues/apa-ethics-code-standards-9-10"
generated: "2026-04-09T16:22:34Z"
---
...
1. **Use tests supported by evidence** – The test should actually measure what you're trying to assess
2. **Follow standardized procedures** – Give and score the test the way it was designed
3. **Use tests validated for your client's population** – The test should have been normed on people similar to your client
...
1. The developing nature of the treatment
2. Potential risks
...
1. Provide pretermination counseling (discussing the decision, reviewing progress)
2. Suggest alternative providers if needed
3. Allow client to ask questions and process the ending
...
- **The S.C.O.R.E. system**:
  - **S**ufficient information before concluding
  - **C**orrect use for validated purposes
  - **O**utdated tests and data require judgment
  - **R**elease test data (not materials) when appropriate
  - **E**xplain results to clients

**For Therapy (Standard 10)**:

- **The C.O.N.S.E.N.T. framework**:
  - **C**ontinuous process, not one-time event
  - **O**ngoing treatment requires ongoing updates
  - **N**ew providers need caution with concurrent treatment
  - **S**exual boundaries are absolute with current clients
  - **E**arly informed consent is required
  - **N**ever provide therapy to sexual partners
  - **T**erminate when no longer beneficial
...
- **Assessment requires adequate information**: Don't offer opinions about someone you haven't personally examined without clearly stating limitations.
- **Tests must be used as designed**: Follow standardized procedures unless research supports modifications for specific populations. Always document adaptations.
- **Know the difference**: Test data (must usually release) vs. test materials (maintain security).
- **Informed consent is ongoing**: Not just a form, but a continuous conversation throughout assessment and therapy.
- **Multiple roles require caution**: Be very careful seeing clients who are receiving services elsewhere. Coordinate care when appropriate.
- **Sexual boundaries are non-negotiable**: Never with current clients, their relatives, or significant others. Essentially never with former clients either.
- **Terminate thoughtfully**: When clients aren't benefiting, provide pretermination counseling and referrals (unless you're in danger).
- **Document everything**: When you deviate from standard procedures (accommodations, telepsychology, using interpreters), explain how this affects data interpretation.
- **Telepsychology requires special consideration**: Different consent, wider confidence intervals for test interpretation, documentation of limitations.
- **Professional judgment matters**: Many situations (outdated tests, test obsolescence, termination timing) require thoughtful analysis rather than rigid rules.
